---
title: "SSH worktrees"
description: "SSH worktrees"
source: "https://www.onorca.dev/docs/ssh"
---

> **Статус перевода:** исходник. Первоисточник: [Orca Docs / SSH worktrees](https://www.onorca.dev/docs/ssh).
...
2.  Add a target: host, user, port, optional identity file. Orca also imports hosts from OpenSSH config files, including files referenced by `Include` directives.
