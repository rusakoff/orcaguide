...
> **Статус перевода:** исходник. Первоисточник: [Orca Docs / Install](https://www.onorca.dev/docs/install).
...
*   Hold Shift while clicking **Check for Updates** ([Settings → General → Updates](/docs/settings), or the app / Help menu). That single check will include prereleases.
