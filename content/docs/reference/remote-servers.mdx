...
> **Статус перевода:** исходник. Первоисточник: [Orca Docs / Remote Orca Servers](https://www.onorca.dev/docs/remote-servers).
...
Desktop app on the server

`orca serve`

Best for

An old laptop, Mac mini, or desktop

A headless Linux box, VM, or managed service

Setup

Settings and buttons

Terminal command and service configuration
...
While the foreground process or service is running
